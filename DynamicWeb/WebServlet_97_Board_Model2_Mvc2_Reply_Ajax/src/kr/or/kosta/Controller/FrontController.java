...
public class FrontController extends HttpServlet {
  ...
  protected void doProcess(HttpServletRequest request, HttpServletResponse response)
    ...
    /*
     * /* // 글 작세 비밀번호 오류 화면 제공 if(cmdURI.equals("/boardDeleteError.bbs")){ viewPage
     * = "boardDeleteError.jsp"; }
     * 
     * // 글 삭제 처리 if(cmdURI.equals("/boardDelete.bbs")){ cmd = new BoardDeleteCmd();
     * cmd.execute(request, response); viewPage = "boardList.bbs"; }
     * 
     * // 글 검색 처리 if(cmdURI.equals("/boardSearch.bbs")){ cmd = new BoardSearchCmd();
     * cmd.execute(request, response); viewPage = "boardSearchList.jsp"; }
     * 
     * // 답글 작성 화면 제공 if(cmdURI.equals("/boardReplyForm.bbs")){ cmd = new
     * BoardReplyFormCmd(); cmd.execute(request, response); viewPage =
     * "boardReply.jsp"; }
     * 
     * // 답글 작성 처리 if(cmdURI.equals("/boardReply.bbs")){ cmd = new BoardReplyCmd();
     * cmd.execute(request, response); viewPage = "boardList.bbs"; }
     */
