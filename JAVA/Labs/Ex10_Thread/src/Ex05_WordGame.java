...
/*
 * 
 * 문제 main 함수 제외한 Thread 2개 생성 
 * 1. 시간(time) 제어하는 Thread 
 * 2. 단어 입력을 처리하는 Thread
 * 
 * main 함수에서 2개 Thread start
 * 
 * 단 단어를 하나라도 입력해서 확인 버튼을 누르면 시간을 멈추고 프로그램 종료 되게 하세요 .....
 * 
 * Hint : static 자원 활용
 * 
 */
...
public class Ex05_WordGame {
  ...
  public static void main(String[] args) {
    ...
    try {
      word.join(); // main 함수 쓰레드에게 기다려달라고
      time.join(); // main 함수 쓰레드에게 기다려달라고
    } catch (Exception e) {
    ...
    // 다중 계산을 하는 상황에서 최종적인 결과를 처리할 때
    // 경마 게임 최종적인 순위 (경기가 종료되면)
