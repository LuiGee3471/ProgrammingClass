      ...
      <div class="row">
        <div class="col-md-8 col-md-offset-2 text-center inner">
          <div class="animatedParent">
            ...
            <p class="animated fadeInUp">WE ARE TEAM 3, WE CAN DO
              WHATEVER WE WANT!</p>
          </div>
        </div>
      </div>
            ...
            <c:when test="${sessionScope.userid != null }">
              ...
              <form action="EmpSearch" method="post">
                &nbsp;&nbsp; <input type="text" name="search"
                  id="search" placeholder="사원이름을 입력하세요"
                  class="form-control" style="width: 80%; float: left;" />
                <input type="submit" value="사원검색" id="searchbtn"
                  class="btn" style="width: 100px; float: left;" />
              </form>
            </c:when>
                    ...
                    <form role="form" action="login" method="post"
                      ...
                      <div class="form-group">
                        ...
                        <input type="password" name="pwd"
                          ...
                          class="form-password form-control" id="pwd">
                      </div>
