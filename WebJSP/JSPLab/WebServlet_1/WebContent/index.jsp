...
<body>
  ...
  <a href="<%=request.getContextPath()%>/simple">일반 요청</a>
  <br>
  <a href="<%=request.getContextPath()%>/simple?type=date">날짜 요청</a>
  <br>
  <a href="<%=request.getContextPath()%>/simple?type=aaaa">비정상 요청</a>
  <br>
