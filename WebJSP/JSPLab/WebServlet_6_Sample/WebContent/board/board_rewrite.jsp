      ...
      <form name="bbs" action="board_rewriteok.jsp" method="POST">
        ...
        <table width="95%" border="2" align="center">
          ...
          <tr>
            ...
            <td width="80%" align="left"><textarea rows="10"
          ...
          <tr>
            <td colspan="2" align="center"><input type="button"
              value="글쓰기" onclick="boardcheck();" /> <input
              type="reset" value="다시쓰기" /> <a
              href="<%=request.getContextPath()%>/board/board_list.jsp">HOME</a>
            </td>
          </tr>
        </table>
      </form>
